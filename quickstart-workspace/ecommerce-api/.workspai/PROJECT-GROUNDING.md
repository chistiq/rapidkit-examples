...
This project is part of the **quickstart-workspace** Workspai workspace.
...
- Name: `ecommerce-api`
- Workspace-relative identity: `ecommerce-api`
- Runtime: `python`
- Framework: `fastapi`
- Relationship: `managed`
- Related projects: `product-api`
...
- Project-scoped entities: 793
- Project-scoped relations: 1086
- Portable proofs: 1138

- **warning · graph.knowledge.project_relationships_unknown:** 2 project(s) have no proven inter-project relationship. This is unknown topology, not proof of independence.
...
npx workspai workspace graph search "ecommerce-api" --limit 12 --json
