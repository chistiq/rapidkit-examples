...
- Name: `product-api`
- Workspace-relative identity: `product-api`
- Runtime: `python`
- Framework: `fastapi`
- Relationship: `managed`
- Related projects: `ecommerce-api`
...
- Project-scoped entities: 797
- Project-scoped relations: 1105
- Portable proofs: 1159
...
npx workspai workspace graph search "product-api" --limit 12 --json
