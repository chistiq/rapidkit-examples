...
- Name: `saas-admin`
- Workspace-relative identity: `saas-admin`
- Runtime: `python`
- Framework: `fastapi`
- Relationship: `managed`
- Related projects: `saas-webhooks`
...
- Project-scoped entities: 957
- Project-scoped relations: 1503
- Portable proofs: 1573
...
npx workspai workspace graph search "saas-admin" --limit 12 --json
