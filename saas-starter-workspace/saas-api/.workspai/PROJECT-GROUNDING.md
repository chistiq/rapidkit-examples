...
- Name: `saas-api`
- Workspace-relative identity: `saas-api`
- Runtime: `python`
- Framework: `fastapi`
...
- Project-scoped entities: 1084
- Project-scoped relations: 1818
- Portable proofs: 1897
...
npx workspai workspace graph search "saas-api" --limit 12 --json
