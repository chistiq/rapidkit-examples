...
- Name: `saas-nest`
- Workspace-relative identity: `saas-nest`
- Runtime: `node`
- Framework: `nestjs`
...
- Project-scoped entities: 667
- Project-scoped relations: 975
- Portable proofs: 953
...
npx workspai workspace graph search "saas-nest" --limit 12 --json
