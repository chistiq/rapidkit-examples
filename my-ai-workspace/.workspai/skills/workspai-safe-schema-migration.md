...
> Workspace: **my-ai-workspace** · Skill: `workspai-safe-schema-migration`
...
- **ai-agent**: owns `none`; publishes `none`; consumes `none`
- **ai-agent-nest**: owns `none`; publishes `none`; consumes `none`
