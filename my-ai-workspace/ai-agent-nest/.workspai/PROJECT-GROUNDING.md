...
This project is part of the **my-ai-workspace** Workspai workspace.
...
- Name: `ai-agent-nest`
- Workspace-relative identity: `ai-agent-nest`
- Runtime: `node`
- Framework: `nestjs`
...
- Project-scoped entities: 359
- Project-scoped relations: 492
- Portable proofs: 452
...
npx workspai workspace graph search "ai-agent-nest" --limit 12 --json
